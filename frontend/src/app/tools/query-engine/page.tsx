...
export default function QueryEnginePage() {
  ...
  return (
    <div className="container mx-auto py-8">
      <div className="mb-8">
        <h1 className="text-2xl font-bold">Legislation Query Engine</h1>
        <p className="text-muted-foreground">
          Ask questions about the legislation and get both an answer and the relevant fragments.
        </p>
      </div>
      <div className="w-full space-y-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="flex gap-2">
            <Input
              placeholder="Ask a question about the legislation..."
              value={query}
        ...
        {response && (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="font-semibold mb-4">Retrieved Fragments:</h3>
